...
class DatasetPASCAL(Dataset):
    def __init__(self, datapath, fold, transform, split, shot, use_original_imgsize):
        ...
        self.img_path = os.path.join(datapath, 'VOC2012_1/JPEGImages/')
        self.ann_path = os.path.join(datapath, 'VOC2012_1/SegmentationClassAug_fin_2/')
    ...
    def __getitem__(self, idx):
        ...
        query_img = query_img.convert('RGB')  #尝试
        ...
        support_imgs = torch.stack([self.transform(support_img.convert('RGB')) for support_img in support_imgs])
    ...
    def build_img_metadata(self):
        ...
        def read_metadata(split, fold_id):
            fold_n_metadata = os.path.join('/home/ljz/lwh/fewshot_HSN/data/splits/pascal_DLRSD/%s/fold%d.txt' % (split, fold_id))
            #fold_n_metadata = os.path.join('D:/hsnet-main/data/splits/pascal_2/%s/fold%d.txt' % (split, fold_id))
